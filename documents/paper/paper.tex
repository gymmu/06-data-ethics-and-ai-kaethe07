...
\abstract{
    In diesem Dokument werde ich mich mit der Frage beschäftigen, ob der Einsatz von 
Künstliche Intelligenz (KI) ethisch vertretbar ist oder nicht, um was man tun müsste
sodamit sie ethisch bleibt. 
}
...
\begin{figure}[H]
    ...
    \caption{Dieses Bild zeigt an wie KI im Gesundheitswesen verwendet wird.}
\end{figure}
