...
vielfältige Möglichkeiten sondern auch Herausforderungen. Hier sind einige Gebiete wo KI angewendet wird: 
...
\citep{mauriceneumann.de}

Bei der Anwendung von KI im Gesundheitsbereich, werden Medizinprodukte und Nicht-Medizinprodukte unterschieden.
Dies basiert auf ihrem Verwendungszweck, ihrer Regulierung und ihren Funktionen. Nicht-Medizinprodukte: hier meint man Geräte, Software oder Anwendungen, die sie auf Gesundheits
und Wohlbefinden konzentrieren, aber keine medizinische Zweckbestimmung haben oder zum Einsatz am Menschen nicht kommen.
\begin{enumerate}
\item Müssen weniger strengen Vorschriften unterliegen. 
\item Müssen grundlegende Sicherheits- und Datenschutzstandards eingehalten.
\item Beispiele: Fitness-Apps und Wearables. 
\end{enumerate}

Medizinprodukte: Geräte, Software oder Anwendungen, die speziell für medizinische Zwecke entwickelt und verwendet werden, wie z.B. Diagnose,
Behandlung oder Überwachung von Krankheiten. 
\begin{enumerate}
\item Müssen strenge Vorschriften einhalten, um sicher und effektiv zu sein. 
\item Sie benötigen eine behördliche Genehmigung, wie z.B. der EMA in Europa.
\item Beispiele: Diagnostische Geräte wie MRTs und Blutzuckermessgeräte, Therapeutische Geräte wie Beatmungsgeräte,
\end{enumerate}
...
Cyberangriffe immer weiter entwickelt. Um solche Sorgen und Problemen zu verhindern, muss sichergestellt werden,
